...
VALUES ('admin', '$2b$12$O9DJgS.9qKJm9XYiwEZXLO9Ci7O3hd/YaL3KSb54VJ6zuuxNyMrsm', 'Admin', 'Example', 'admin@example.com', 2);

INSERT INTO usuarios (username, password_hash, nombre, apellido, email, role_id)
-- VALUES ('user1', 'e606e38b0d8c19b24cf0ee3808183162ea7cd63ff7912dbb22b5e803286b4446', 'User1', 'Example', 'user1@example.com', 1);
VALUES ('user1', '$2b$12$OeAKFQpNILdtsW0.vuF/Y.LQE/I0gp9.pTkLsclkdU8so1Sv7NbbG', 'User1', 'Example', 'user1@example.com', 1);
